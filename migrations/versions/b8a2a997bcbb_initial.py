...
Revision ID: b8a2a997bcbb
Revises: 
Create Date: 2024-08-21 10:47:14.483962
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('attribute_value', 'attribute_id', name='uq_attribute_value_attr_value_attr_id')
    )
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('pid', sa.UUID(), server_default=sa.text('gen_random_uuid()'), nullable=False),
    ...
    sa.Column('sku', sa.UUID(), server_default=sa.text('gen_random_uuid()'), nullable=False),
    sa.Column('stock_qty', sa.Integer(), server_default='0', nullable=False),
    sa.Column('is_active', sa.Boolean(), server_default='False', nullable=False),
    sa.Column('order_num', sa.Integer(), nullable=False),
    sa.Column('weight', sa.Float(), nullable=False),
    sa.Column('product_id', sa.Integer(), nullable=False),
    sa.CheckConstraint('order_num >= 1 AND order_num <= 20', name='product_order_line_range'),
    sa.CheckConstraint('price >= 0 AND price <= 999.99', name='product_line_max_value'),
    sa.ForeignKeyConstraint(['product_id'], ['product.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('order_num', 'product_id', name='uq_product_line_order_product_id'),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('product_id', 'product_type_id', name='uq_prod_prodtype_prod_id_prod_type_id')
    )
    ...
    sa.CheckConstraint('LENGTH(alternative_text) > 0', name='product_image_alt_text_length_check'),
    ...
    sa.UniqueConstraint('product_line_id', name='uq_product_image_product_line_id')
    )
    ...
    sa.ForeignKeyConstraint(['product_line_id'], ['product_line.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('attribute_value_id', 'product_line_id', name='uq_attrval_prodline_attribute_value_id_produ_line_id')
    )
